...
<body>
    ...
    <main class="bg-gray-100 py-12">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="bg-white rounded-xl shadow-highlight p-6 md:flex items-center gap-8">
                <!-- Profile Image -->
                <div class="flex justify-center md:justify-start">
                    <div
                        class="w-32 h-32 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-white" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M12 12c2.28 0 4.07-1.79 4.07-4.07S14.28 3.86 12 3.86s-4.07 1.79-4.07 4.07S9.72 12 12 12zM19 21H5c-.83 0-1.5-.67-1.5-1.5S4.17 18 5 18h14c.83 0 1.5.67 1.5 1.5S19.83 21 19 21z" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="mt-6 md:mt-0 flex-1">
                    <h2 class="text-3xl font-bold text-gray-800">Admin Profil</h2>
                    <p class="text-sm text-gray-500 mt-1">Kelola informasi dan aktivitas Anda</p>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                        <div>
                            <p class="text-sm text-gray-500">Nama</p>
                            <p class="text-lg font-semibold text-gray-700">Maryana</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Email</p>
                            <p class="text-lg font-semibold text-gray-700">maryana@example.com</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Nomor Telepon</p>
                            <p class="text-lg font-semibold text-gray-700">0848-5585-6685</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Alamat</p>
                            <p class="text-lg font-semibold text-gray-700">Bengkalis</p>
                        </div>
                    </div>
