                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div
                            ...
                            <img src="{{ asset('assets/img/tariPiring.jpg') }}" alt="Gallery Image 1" class="w-full">
                            <div class="p-4">
                        ...
                        <div
                            class="swiper-slide bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden transition">
                            <img src="{{ asset('assets/img/makeup.jpg') }}" alt="Gallery Image 2" class="w-full">
                            <div class="p-4">
                        ...
                        <div
                            class="swiper-slide bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden transition">
                            <img src="{{ asset('assets/img/image.png') }}" alt="Gallery Image 3" class="w-full">
                            <div class="p-4">
