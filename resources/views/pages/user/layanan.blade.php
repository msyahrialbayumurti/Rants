...
<head>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: [{
                    title: 'Jasa Tari - Acara Pernikahan',
                    start: '2025-01-20',
                    color: '#3b82f6',
                    description: 'Acara pernikahan yang membutuhkan jasa tari tradisional.'
                },
                {
                    title: 'Makeup - Pemotretan',
                    start: '2025-01-22',
                    color: '#ef4444',
                    description: 'Pemotretan dengan layanan makeup profesional.'
                },
                {
                    title: 'Kostum - Pameran Tradisional',
                    start: '2025-01-25',
                    end: '2025-01-27',
                    color: '#10b981',
                    description: 'Pameran tradisional dengan penyewaan kostum.'
                }
            ],
                    ...
                    eventsOnDate.forEach(event => {
                        details += `
                            <div class='mb-4'>
                                ...
                                <p class='text-gray-600 mt-2'>${event.extendedProps.description}</p>
                                <p class='text-gray-500 mt-2'>Tanggal: ${event.start.toLocaleDateString('id-ID')}</p>
                            </div>
                        `;
                    });
    ...
    <main class="bg-gray-100">
        <div class="container mx-auto p-6">
            ...
            <div class="flex flex-col lg:flex-row gap-8 mt-8">
                <div class="calendar-card p-6 lg:w-1/2">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Jadwal Layanan</h2>
                    <div id="calendar"></div>
                    <div id="event-details" class="mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
